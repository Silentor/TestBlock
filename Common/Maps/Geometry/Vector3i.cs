...
namespace Silentor.TB.Common.Maps.Geometry
{
    public struct Vector3i
    {
        ...
        //public static implicit operator Vector3i(CardinalDirections direction)
        //{
        //    return direction == CardinalDirections.None ? Zero : Directions[(int) direction];
        //}

        public static implicit operator Vector3i(CubeFace face)
        {
