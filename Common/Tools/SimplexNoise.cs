 ...
 */
    ...
    public class SimplexNoise
    {
        ...
        private const float F2 = 0.36602540378443864676372317075294f; // (float)(0.5*(Mathf.Sqrt(3.0f)-1.0)); 
        private const float G2 = 0.21132486540518711774542560974902f; // (float)((3.0 - Mathf.Sqrt(3.0f)) / 6.0); 
        ...
        //private static final float F4 = (Math.sqrt(5.0)-1.0)/4.0;
        //private static final float G4 = (5.0-Math.sqrt(5.0))/20.0;
